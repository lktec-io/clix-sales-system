...
function useReportConfigs(t) {
  ...
  return {
    ...
    // Consolidated Restaurant report — Sales/Revenue, Orders, Best-selling
    // Menu Items and Payment Summary all in one report via three
    // breakdowns, mirroring the Pharmacy/Microfinance consolidation.
    restaurant_sales: {
      label: t('reports:types.restaurant_sales'), description: t('reports:descriptions.restaurant_sales'),
      filters: ['dateFrom', 'dateTo', 'branchId'],
      summary: {
        totalOrders: t('reports:summary.totalOrders'), totalRevenue: t('reports:summary.totalRevenue'),
        averageOrder: t('reports:summary.averageOrder'),
      },
      breakdowns: [
        { key: 'byDay', title: t('reports:breakdowns.byDay'), labelHeader: t('reports:headers.date') },
        { key: 'byMenuItem', title: t('reports:breakdowns.byMenuItem'), labelHeader: t('reports:headers.menuItem') },
