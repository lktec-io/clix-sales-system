...
function useActions() {
  ...
  return [
    { label: t('quickActions.newSale'), icon: FiDollarSign, to: '/pos', accent: '#2F6BFF' },
    { label: t('quickActions.newCustomer'), icon: FiUserPlus, to: '/customers', accent: '#14B8A6' },
    { label: t('quickActions.newExpense'), icon: FiCreditCard, to: '/expenses', accent: '#F59E0B' },
    { label: t('quickActions.reports'), icon: FiBarChart2, to: '/reports', accent: '#8B5CF6' },
  ];
}
